try {
    ...
    option1: function () {
        ...
        return date_validation(datetime_published);
    },
    option2: function () {
    ...
    */
    option10: function() {
        ...
        return date_validation( (typeof json.datePublished !== 'undefined') ? json.datePublished : '' );
    },
    /**
      * Sources include:
    ...
    */
    option12: function() {
        ...
        return date_validation(datetime_published_formatted(datetime_published));
    },
    /**
      * Sources include:
    ...
    */
    ...
    option14: function() {
        var datetime_published = $("meta[name='publishdate']").attr("content");
        return date_validation(datetime_published);
    }
});
...
function date_validation (datetime) {
